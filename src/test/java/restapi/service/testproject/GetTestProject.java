...
//    	System.out.println(beanList.get(1).getName());
       	...
       	ArrayList<TestProjectBean> tps=tpService.getTestProjectList();
    	System.out.println(res);
    	
	}
	
	@Test
	public void TestGetTestProjectList(){
  	
       	ArrayList<TestProjectBean> tps=tpService.getTestProjectList();
       	for(TestProjectBean tp:tps){
       	System.out.println("id='"+tp.getId()+"' name='"+tp.getName()+"'");
       	}
